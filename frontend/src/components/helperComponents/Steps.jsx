    ...
    <div className="w-full py-4 px-4">
      <div className="max-w-6xl mx-auto flex items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-500 font-medium text-sm hidden sm:inline">Refined</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-gray-500 font-medium text-sm hidden sm:inline">Generate Story</span>
        </div>
    ...
    <div className="w-full py-4 px-4">
      <div className="max-w-6xl mx-auto flex items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-medium text-sm hidden sm:inline">Background</span>
        </div>
    ...
    <div className="w-full py-4 px-4">
      <div className="max-w-6xl mx-auto flex items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-medium text-sm hidden sm:inline">Covers</span>
        </div>
    ...
    <div className="w-full py-4 px-4">
      <div className="max-w-6xl mx-auto flex items-center justify-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-medium text-sm hidden sm:inline">Your Book</span>
      </div>
    </div>  
    </div>
  );
