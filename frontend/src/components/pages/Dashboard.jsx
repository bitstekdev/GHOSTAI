...
const Dashboard = () => {
  ...
  const shouldRunTourOnThisPage =
    activeTour === "onboarding" && window.location.pathname === "/dashboard";
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="flex gap-1 items-end h-16">
              {[40, 60, 50, 70, 55, 80, 65, 75].map((h, i) => (
                <div
                  key={i}
                  className="w-2 bg-purple-300 rounded"
                  style={{ height: `${h}%` }}
                />
              ))}
            </div>
      ...
      <div className="bg-gray-800 rounded-xl p-6">
        ...
        {!loading && !error && allStories.length === 0 && (
          <div className="text-center py-8">
            <p className="text-gray-400 mb-4">
              No stories yet. Start creating your first story!
            </p>
            <button
        ...
        {!loading &&
          ...
          allStories.slice(0, 4).map((story) => (
            <div
              key={story._id}
              className="story-item bg-gray-900 rounded-lg p-4 mb-3 flex items-center justify-between">
              <div>
