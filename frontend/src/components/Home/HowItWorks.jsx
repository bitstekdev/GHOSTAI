...
const HowItWorks = () => {
  ...
  return (
    <section
      id="how-it-works"
      className="bg-charcoalBlack py-20 sm:py-28 md:py-36 lg:py-48 border-y border-white/5 overflow-hidden perspective-container"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 md:gap-20 lg:gap-24 items-center">

          {/* LEFT — Steps */}
          <div className="reveal-hidden space-y-8 sm:space-y-12 md:space-y-16">
            ...
            <div className="space-y-8 sm:space-y-12 md:space-y-16">
              {steps.map((s, i) => (
                <div
                  key={i}
                  className="flex gap-6 sm:gap-8 md:gap-10 group reveal-hidden"
                  style={{ transitionDelay: `${i * 100}ms` }}
                >
                  <div className="font-serif text-4xl sm:text-5xl md:text-6xl text-polishedPurple/20 group-hover:text-polishedPurple transition-all duration-700 shrink-0 transform group-hover:scale-110 group-hover:rotate-12">
                    {s.num}
                  </div>

                  <div className="space-y-2 sm:space-y-3 pt-1 sm:pt-2">
                    <h3 className="text-xl sm:text-2xl font-medium text-ghostWhite group-hover:text-polishedPurple transition-colors">
                      {s.title}
                    </h3>
          ...
          {/* RIGHT — 3D Collage - Simplified for mobile */}
          <div className="relative reveal-hidden flex items-center justify-center" style={{ transitionDelay: "400ms" }}>
            
            {/* MOBILE: Simple Stacked Cards */}
            <div className="lg:hidden space-y-6 w-full max-w-sm mx-auto">
              <div className="w-full aspect-[4/5] rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl border border-white/5">
                <img
                  src="https://images.unsplash.com/photo-1455390582262-044cdead277a?q=80&w=800&auto=format&fit=crop"
                  alt="Writing desk"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-polishedPurple/10" />
              </div>
              ...
              <div className="w-full aspect-[4/5] rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl border border-white/5">
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-polishedPurple/40 to-transparent" />
                <div className="absolute bottom-6 left-6 right-6 flex items-center gap-3 text-ghostWhite z-20">
            ...
            <div className="hidden lg:block relative h-[700px] w-full">
              {/* Top Card */}
              <div className="absolute top-0 right-0 w-72 h-96 rounded-3xl overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.5)] rotate-12 z-10 border border-white/5 transition-all duration-1000 hover:rotate-0">
                <img
                  src="https://images.unsplash.com/photo-1455390582262-044cdead277a?q=80&w=800&auto=format&fit=crop"
                  alt="Writing desk"
                  className="w-full h-full object-cover"
              ...
              {/* Bottom Card */}
              <div className="absolute bottom-0 left-0 w-80 h-[500px] rounded-3xl overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.5)] -rotate-6 z-20 border border-white/5 transition-all duration-1000 hover:rotate-0">
                <img
                  src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?q=80&w=800&auto=format&fit=crop"
                  alt="Library atmosphere"
                  className="w-full h-full object-cover"
              ...
              {/* Center Card */}
              <div className="relative w-96 h-[600px] rounded-3xl overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.7)] z-30 transition-all duration-1000 hover:scale-105 mx-auto">
                <img
                  src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=1200&auto=format&fit=crop"
                  alt="A child exploring books"
                  className="w-full h-full object-cover"
